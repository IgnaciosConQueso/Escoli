...
<body>
    ...
    <section class = "center">
        ...
        <dl>
            <dt id = "limon">
                <a href = "https://github.com/Lem0z3n"><img class = "fotoperfil" src="fotosdeperfil/limonpp.JPG" alt ="githubGuille" title = "githubGuille"><u class = "nombrePropio">Guillermo "limón" Lemonnier:</u></a>
            </dt>
            <dd>
            ...
            <dt id = "luque">
            <a href = "https://github.com/aluque1"> <img class = "fotoperfil" src="fotosdeperfil/luquepp.jpeg" alt = "githubLuque" title = "githubLuque"><u class = "nombrePropio" >Alejandro "luque" Luque: </u> </a>
            </dt>
            <dd>
            ...
            <dt id = "jorbis">
                <a  href = "https://github.com/Jorbis21"><img class = "fotoperfil" src ="fotosdeperfil/orbispp.jpg" alt ="githubOrbis" title = "githubOrbis"><u class = "nombrePropio" >Javier "jorbis" Orbis:</u></a>
            </dt>
            <dd>
                <p> Me gusta leer y jugar videojuegos, además soy muy guapo. <mark> jorbis@ucm.es </mark></p>
            </dd>
            <dt id = "pablo">
                <a  href = "https://github.com/pagarc24"><img class = "fotoperfil" src ="fotosdeperfil/pablopp.jpg" alt = "githubPablo" title = "githubPablo"><u class = "nombrePropio" >Pablo "español" García:</u></a>        
            </dt>
            <dd>
                <p> Me gusta escuchar música, jugar al futbol y quedar con mis amigos en el parque. <mark> pagarc24@ucm.es </mark> </p>
            </dd>
            <dt id = "nacho">
                <a href = "https://github.com/Nachoski08"><img class = "fotoperfil" src ="fotosdeperfil/nachopp.jpg" alt = "githubNacho" title = "githubNacho"><u class = "nombrePropio" >Ignacio "Nacho" Sánchez:</u></a>
            </dt>
            <dd>
