...
<dl>
    <dt id="limon">
        <a href="https://github.com/Lem0z3n"><img class="fotoperfil" src="<?= getImagen('/fotosdeperfil/limonpp.JPG') ?>" alt="githubGuille" title="githubGuille"><u class="nombrePropio">Guillermo "limón" Lemonnier:</u></a>
    </dt>
    <dd>
    ...
    <dt id="luque">
        <a href="https://github.com/aluque1"> <img class="fotoperfil" src="<?= getImagen('fotosdeperfil/luquepp.jpeg') ?>" alt="githubLuque" title="githubLuque"><u class="nombrePropio">Alejandro "luque" Luque: </u> </a>
    </dt>
    <dd>
    ...
    <dt id="nacho">
        <a href="https://github.com/Nachoski08"><img class="fotoperfil" src="<?= getImagen('fotosdeperfil/nachopp.jpg') ?>" alt="githubNacho" title="githubNacho"><u class="nombrePropio">Ignacio "Nacho" Sánchez:</u></a>
    </dt>
    <dd>
