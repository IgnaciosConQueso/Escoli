...
abstract class Formulario
{
    ...
    protected function procesaImagen($ruta){
     ...
     */
    protected static function check_file_uploaded_name($filename)
    {
     ...
     */
    protected static function sanitize_file_uploaded_name($filename)
    {
